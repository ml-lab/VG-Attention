...
cmd:text()
cmd:text('Options')
cmd:option('-input_json','augmented_decoys/VG_train_decoys.region_augmented.json','path to the json file containing vocab and answers')
...
cmd:option('-out_name', 'regional_feature/vg_img_residule_attended_train.h5', 'output name train')
